...
class Button:
    def __init__(self, screen, x, y, width, hight, image="", color=(240, 240, 240), 
                 color_click=(210, 210, 210), font_size=18, edge_width=0, font=None, click_img=None, text=None, cmd=None):
        self.screen = screen
        self.x_pos_button = x
        self.y_pos_button = y
...
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        if self.img == 1:
            ...
            if self.font == None:
                self.screen.blit(pygame.font.SysFont("consolas", self.font_size).render(str(self.image_button), False, (33, 33, 33)), 
                                (self.x_pos_button + self.width_button // 2 - 5 * len(self.image_button), 
                                 self.y_pos_button + self.hight_button // 2 - 11))
            else:
                self.screen.blit(self.font.render(str(self.image_button), False, (33, 33, 33)), 
                                (self.x_pos_button + self.width_button // 2 - 5 * len(self.image_button), 
                                 self.y_pos_button + self.hight_button // 2 - 11))
        ...
        if self.font != None and self.text != None:
            self.screen.blit(self.font.render(self.text, False, (33, 33, 33)), 
                            (self.x_pos_button + self.width_button // 2 - 5 * len(self.image_button), 
                             self.y_pos_button + self.hight_button // 2 - 11))
